...
//*******************************************************************************************Suggestions
                ...
                art.forEach(art => {
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-4 relative">
                        ...
                        <p class="text-gray-700 mt-2 display-none md:display-block">${art.description}</p>
                        <div class="mt-4 text-sm display-none md:display-block text-gray-500">
            ...
            document.querySelectorAll('.read-button').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    window.location.href = "../html/sugArt.html"; 
...
// ***************************************************************************************Add layer => the map
                   async function getWFSgeojson(wfsURL) {
                    ...
                    function createLayer(layerData) {
                        const { name, wfsURL, color, weight, type, lat, long, popUp } = layerData;
                    //getWFSgeojson(wfsURL) pro for MARKERS 
                    if(type == "marker") {
                        console.log(10);
                        ...
                        map.setView([lat, long], map.getZoom());  // You can adjust the zoom level as needed
                    }
                            ...
                            if (geojsonData) {
                                ...
                                switch (type) {
                                    ...
                                    case 'point':
                                        ...
                                        break;
                                   /* case 'marker':  // New case for marker
                                    console.log(10)
                                ...
                                // Fit the map bounds to the new layer if applicable
